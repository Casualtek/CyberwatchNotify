...
def load_articles_from_json(url):
...
def main():
    ...
    tweet = flag.flag(countryISO[country])+' '+story['victim']+' a été victime d\'une #cyberattaque autour du '+date_tweet+'. src 👉 '+story['url']+' cc @ransomwaremap @cyber_etc'
    
    tweetbot = tweepy.Client(bearer_token, consumer_key, consumer_secret, access_token, access_token_secret)
    tweetbot.create_tweet(text=tweet)
